...
class JoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create join" do
    assert_difference('Join.count') do
      post joins_url, params: { join: { project_id: @join.project_id, user_id: @join.user_id } }
    end
  ...
  test "should update join" do
    patch join_url(@join), params: { join: { project_id: @join.project_id, user_id: @join.user_id } }
